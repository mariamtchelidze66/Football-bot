...
SYSTEM_PROMPT = (
    ...
    "4. Premier League official website (premierleague.com)\n"
    "5. The club's official website\n"
    "Never report injury or lineup information from any other source. "
    "Cite the source for every piece of injury or lineup information, e.g. '(Source: BBC Sport)'. "
    "If you cannot find the information from one of these five sources after searching, "
    "you MUST state: 'Could not find from trusted sources' — do not guess or use unofficial sources.\n\n"
